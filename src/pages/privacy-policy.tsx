...
export default function PrivacyPolicy() {
  return (
    <PublicLayout>
      <h1>Privacy Policy for Terrakota Stock Exchange</h1>

      <p>
        At Terrakota Stock Exchange, accessible from sahamterrakota.org, one of
        ...
        Terrakota Stock Exchange and how we use it.
      </p>
      ...
      <p>
        Terrakota Stock Exchange follows a standard procedure of using log
      ...
      <p>
        ...
        advertising partners of Terrakota Stock Exchange.
      </p>

      <p>
        Third-party ad servers or ad networks uses technologies like cookies,
        JavaScript, or Web Beacons that are used in their respective
        advertisements and links that appear on Terrakota Stock Exchange, which
      ...
      <p>
        Note that Terrakota Stock Exchange has no access to or control over
      ...
      <p>
        Terrakota Stock Exchange's Privacy Policy does not apply to other
      ...
      <p>
        Terrakota Stock Exchange does not knowingly collect any Personal
      ...
      <p>
        ...
        shared and/or collect in Terrakota Stock Exchange. This policy is not
