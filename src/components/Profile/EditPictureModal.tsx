  ...
  return (
    <>
      <Button w="8em" h="8em" borderRadius="4em" mt="1em" onClick={onOpen} overflow="hidden">
        {imageUrl ? <Image src={imageUrl} w="8em" alt="User Image"/> : <MdPerson size="8em" />}
      </Button>
      <Modal isOpen={isOpen} onClose={onClose}>
        ...
        <ModalContent>
          ...
          >
            {picInput ? (
              <Image src={URL.createObjectURL(picInput)} w="8em" h="8em" alt="User Image"/>
            ) : profile.imageUrl ? (
              <Image src={profile.imageUrl} w="8em" h="8em" alt="User Image"/>
            ) : (
              <MdPerson size="8em" />
            )}
          </Box>
